...
#player_rankings %>% ungroup() %>% group_by(player)

```


```{r, fig.width=6, fig.height=10}
player_rankings_ %>% ggplot(aes(ranking_date, rank, color = player)) +
    ...
    labs(x = "Date", y = "Tournament Ranking",
     title = "Player Ranking Consistency from 2020 to 2022",
     subtitle = "Players whose best ranking is at least 5th",
